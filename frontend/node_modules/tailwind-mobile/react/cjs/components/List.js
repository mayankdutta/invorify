...
const List = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const colors = {
    bg: (0, _cls.cls)(`bg-block-strong-light`, dark('dark:bg-block-strong-dark')),
    ...colorsProp
  };
  const c = themeClasses({
    base: {
      common: (0, _cls.cls)(!nested && margin, colors.bg, !inset && !nested && hairlines && 'hairline-t hairline-b', (0, _positionClass.positionClass)('relative', className), 'z-10')
    },
    ul: {
  ...
  const classes = (0, _cls.cls)(c.base, inset && c.inset, menuList && c.menuList, className);
