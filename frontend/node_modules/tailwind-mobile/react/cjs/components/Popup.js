...
const Popup = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const c = themeClasses({
    base: {
      common: (0, _cls.cls)('left-1/2 top-1/2 transition-transform transform -translate-x-1/2 duration-400 z-40 md:rounded max-w-full max-h-full overflow-hidden md:no-safe-areas', colors.bg, (0, _positionClass.positionClass)('fixed', className), size),
      ios: '',
      material: 'shadow-2xl',
