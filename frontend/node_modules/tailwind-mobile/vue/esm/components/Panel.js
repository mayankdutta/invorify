...
export default {
  ...
  setup(props, ctx) {
    ...
    const c = useThemeClasses(props, () => ({
      base: {
        common: cls('top-0 transition-transform transform duration-400 z-40 max-w-full max-h-full overflow-hidden', colors.value.bg, positionClass('fixed', ctx.attrs.class), props.size),
        ios: '',
        material: 'shadow-2xl'
      },
      left: {
    ...
    const classes = computed(() => cls(c.value.base, c.value[props.side][state.value], ctx.attrs.class));
