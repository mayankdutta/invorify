...
var _default = {
  ...
  setup(props, ctx) {
    ...
    const c = (0, _useThemeClasses.useThemeClasses)(props, () => ({
      base: {
        common: (0, _cls.cls)('left-1/2 top-1/2 transition-transform transform -translate-x-1/2 duration-400 z-40 md:rounded max-w-full max-h-full overflow-hidden md:no-safe-areas', colors.value.bg, (0, _positionClass.positionClass)('fixed', ctx.attrs.class), props.size),
        ios: '',
        material: 'shadow-2xl',
